...
<div class="relative z-0 w-full p-3 dashboard-card md:w-1/2 xl:w-1/3">
  <div class="relative p-2 bg-white border rounded shadow">
    ...
    <div class="flex flex-row items-center">
      <div class="flex-shrink pr-4">
        <div class="p-3 text-blue-600 rounded">
      ...
      <div class="flex-1 text-right md:text-center">
        <h5 class="font-bold text-gray-500 uppercase">Upcoming Anniversaries</h5>
        <h3 class="text-3xl font-bold">
          $AnniversaryEmployees.Count
        </h3>
      </div>
    </div>
  </div>
  ...
  <div
    ...
    <ul class="w-full">
      <% loop AnniversaryEmployees.Sort('AnniversaryDate', ASC) %>
