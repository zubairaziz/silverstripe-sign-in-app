<div class="antialiased sans-serif bg-gray-100">
  <div x-data="calendar()" x-init="[initDate(), getNoOfDays()]" x-cloak>
    <div class="container mx-auto px-4 py-2 md:pt-4">
                ...
                <div style="height: 80px;" class="overflow-y-auto mt-1">
                  ...
                  <template
                    ...
                    <div class="px-2 py-1 rounded-lg mt-1 overflow-hidden border" :class="{
												'border-primary-200 text-primary-800 bg-primary-100': event.event_theme === 'primary',
      ...
      <div class="p-4 max-w-xl mx-auto relative absolute left-0 right-0 overflow-hidden mt-24">
        ...
        <div class="shadow w-full rounded-lg bg-white overflow-hidden w-full block p-8">
          ...
          <div class="mb-4">
            ...
            <input
              class="bg-gray-200 appearance-none border-2 border-gray-200 rounded-lg w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-primary-500"
          ...
          <div class="inline-block w-64 mb-4">
            ...
            <div class="relative">
              <select @change="event_theme = $event.target.value;" x-model="event_theme"
                class="block appearance-none w-full bg-gray-200 border-2 border-gray-200 hover:border-gray-500 px-4 py-2 pr-8 rounded-lg leading-tight focus:outline-none focus:bg-white focus:border-primary-500 text-gray-700">
